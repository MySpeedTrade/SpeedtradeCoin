...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SpeedtradeCoin"),
     ...
     * override -datadir in the speedtradecoin.conf file in the default data directory
     * (to be consistent with speedtradecoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
