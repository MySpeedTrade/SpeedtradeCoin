...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MMSTC);
    unitlist.append(kMSTC);
    unitlist.append(MSTC);
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MMSTC: return QString("MMSTC");
    case kMSTC: return QString("kMSTC");
    case MSTC: return QString("MSTC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MMSTC: return QString("Mega-SpeedtradeCoin (1,000,000 MSTC)");
    case kMSTC: return QString("Kilo-SpeedtradeCoin (1000 MSTC)");
    case MSTC: return QString("SpeedtradeCoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MMSTC: return Q_INT64_C(100000000000000);
    case kMSTC: return Q_INT64_C(100000000000);
    case MSTC:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MMSTC: return Q_INT64_C(900000);
    case kMSTC: return Q_INT64_C(900000000);
    case MSTC:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MMSTC: return 6;  // 900,000 (# digits, without commas)
    case kMSTC: return 9;  // 900,000,000
    case MSTC:  return 12; // 900,000,000,000
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case MMSTC: return 14;
    case kMSTC: return 11;
    case MSTC: return 8;
