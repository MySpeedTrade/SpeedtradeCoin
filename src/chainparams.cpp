...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("myspeedtrade.com", "mstc.allblockchaininfo.xyz"));
        vSeeds.push_back(CDNSSeedData("speedtradecoin.net", "seeds.speedtradecoin.net"));
        vSeeds.push_back(CDNSSeedData("seeds1.myspeedtrade.com", "seeds2.speedtradecoin.com"));
        vSeeds.push_back(CDNSSeedData("pool.speedtradecoin.com", "explorer.speedtradecoin.com"));
        vSeeds.push_back(CDNSSeedData("pool.myspeedtrade.com", "explorer.myspeedtrade.com"));
