...
# Copyright (c) 2014 The SpeedtradeCoin Core developers
...
BITCOIND=${1}/speedtradecoind
CLI=${1}/speedtradecoin-cli
...
# B1 should still be able to spend 1000000 (-1 MSTC fee for the successful transaction), because D is conflicted
