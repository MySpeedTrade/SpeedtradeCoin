# SpeedtradeCoin Core 1.8.1

SpeedtradeCoin Core 1.8.1 is primarily a bugfix release, bringing SpeedtradeCoin Core in
line with Bitcoin 0.9.3. SpeedtradeCoin Core 1.8.1 also adds in support for printing
...
* Disable Transifex based translation process (not used by SpeedtradeCoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 SpeedtradeCoin Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/speedtradecoin/speedtradecoin/issues/134).
