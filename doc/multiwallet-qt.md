...
In order to support loading of multiple wallets in speedtradecoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to speedtradecoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into speedtradecoin-qt, and as such, will require some minor modifications to provide hooks for
